...
public class DetailFragment extends Fragment {
    ...
    private void setData(View rootView, Bundle bundle) {
        ...
        TextView pledge = rootView.findViewById(R.id.tv_pledge);
        ...
        pledge.setText((projectDetails.getCurrency().equalsIgnoreCase
                (getString(R.string.compare_currency)) ?
               getString(R.string.label_symbol) : projectDetails.getCurrency())+projectDetails.getAmtPledged());
