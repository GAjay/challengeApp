...
public class ProjectListingAdapter extends BaseAdapter implements Filterable {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        String amtPledged = context.getString(R.string.label_no_pledged) + " " +
                (filterList.get(position).getCurrency().equalsIgnoreCase
        ...
        String backers = context.getString(R.string.label_backers) + " " +
                filterList.get(position).getNumBackers();
